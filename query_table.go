...
func (t RqlTerm) TableCreate(name string) RqlTerm {
	return newRqlTermFromPrevVal(t, "TableCreate", p.Term_TABLE_CREATE, List{name}, Obj{})
}

func (t RqlTerm) TableDrop(name string) RqlTerm {
