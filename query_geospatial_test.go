...
func (s *RethinkSuite) TestGeospatialGeometryPseudoType(c *test.C) {
	...
	c.Assert(response, test.DeepEquals, types.Geometry{
		...
		Lines: types.Lines{
			types.Line{
				types.Point{-122.423246, 37.779388},
				types.Point{-122.423246, 37.329898},
				types.Point{-121.88642, 37.329898},
				types.Point{-121.88642, 37.779388},
				types.Point{-122.423246, 37.779388},
			},
		},
	})
...
func (s *RethinkSuite) TestGeospatialCircle(c *test.C) {
	...
	c.Assert(response, test.DeepEquals, types.Geometry{
		...
		Lines: types.Lines{
			types.Line{
				types.Point{-122.423246, 37.77929790366427},
				types.Point{-122.42326814543915, 37.77929963483801},
				types.Point{-122.4232894398445, 37.779304761831504},
				types.Point{-122.42330906488651, 37.77931308761787},
				types.Point{-122.42332626638755, 37.77932429224285},
				types.Point{-122.42334038330416, 37.77933794512014},
				types.Point{-122.42335087313059, 37.77935352157849},
				types.Point{-122.42335733274696, 37.77937042302436},
				types.Point{-122.4233595139113, 37.77938799994533},
				types.Point{-122.42335733279968, 37.7794055768704},
				types.Point{-122.42335087322802, 37.779422478327966},
				types.Point{-122.42334038343147, 37.77943805480385},
				types.Point{-122.42332626652532, 37.779451707701796},
				types.Point{-122.42330906501378, 37.77946291234741},
				types.Point{-122.42328943994191, 37.77947123815131},
				types.Point{-122.42326814549187, 37.77947636515649},
				types.Point{-122.423246, 37.779478096334365},
				types.Point{-122.42322385450814, 37.77947636515649},
				types.Point{-122.4232025600581, 37.77947123815131},
				types.Point{-122.42318293498623, 37.77946291234741},
				types.Point{-122.42316573347469, 37.779451707701796},
				types.Point{-122.42315161656855, 37.77943805480385},
				types.Point{-122.423141126772, 37.779422478327966},
				types.Point{-122.42313466720033, 37.7794055768704},
				types.Point{-122.42313248608872, 37.77938799994533},
				types.Point{-122.42313466725305, 37.77937042302436},
				types.Point{-122.42314112686942, 37.77935352157849},
				types.Point{-122.42315161669585, 37.77933794512014},
				types.Point{-122.42316573361246, 37.77932429224285},
				types.Point{-122.4231829351135, 37.77931308761787},
				types.Point{-122.42320256015552, 37.779304761831504},
				types.Point{-122.42322385456086, 37.77929963483801},
				types.Point{-122.423246, 37.77929790366427},
			},
		},
	})
...
func (s *RethinkSuite) TestGeospatialGeojson(c *test.C) {
	...
	c.Assert(response, test.DeepEquals, types.Geometry{
		Type:  "Point",
		Point: types.Point{-122.423246, 37.779388},
	})
}
...
func (s *RethinkSuite) TestGeospatialLineLatLon(c *test.C) {
	...
	c.Assert(response, test.DeepEquals, types.Geometry{
		...
		Line: types.Line{
			types.Point{-122.423246, 37.779388},
			types.Point{-121.886420, 37.329898},
		},
	})
}
...
func (s *RethinkSuite) TestGeospatialPolygon(c *test.C) {
	...
	c.Assert(response, test.DeepEquals, types.Geometry{
		...
		Lines: types.Lines{
			types.Line{
				types.Point{Lat: -122.423246, Lon: 37.779388},
				types.Point{Lat: -122.423246, Lon: 37.329898},
				types.Point{Lat: -121.88642, Lon: 37.329898},
				types.Point{Lat: -122.423246, Lon: 37.779388},
			},
		},
	})
...
func (s *RethinkSuite) TestGeospatialPolygonSub(c *test.C) {
	...
	c.Assert(response, test.DeepEquals, types.Geometry{
		...
		Lines: types.Lines{
			types.Line{
				types.Point{-122.4, 37.7},
				types.Point{-122.4, 37.3},
				types.Point{-121.8, 37.3},
				types.Point{-121.8, 37.7},
				types.Point{-122.4, 37.7},
			},
			types.Line{
				types.Point{-122.3, 37.4},
				types.Point{-122.3, 37.6},
				types.Point{-122, 37.6},
				types.Point{-122, 37.4},
				types.Point{-122.3, 37.4},
			},
		},
	})
