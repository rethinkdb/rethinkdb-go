...
func (suite *TransformationSuite) TestCases() {
...

	{
		...
		runAndAssert(suite.Suite, expected_, tbl.IndexCreateFunc("truncated_a", func(x r.Term) interface{} { return []interface{}{"", x.AtIndex("a")}}), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
